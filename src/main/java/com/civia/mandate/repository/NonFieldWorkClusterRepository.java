...
public interface NonFieldWorkClusterRepository extends MandateModelRepository {
    ...
    @Aggregation(pipeline = {
            "{ $vectorSearch: { "
                    ...
                    + "limit: 1000 "
                    + "} }",
            "{ $project: { _id: 1, name: 1, cost: 1, address: 1, reason: 1, request: 1, observation: 1, signature: 1, rut: 1, phoneNumber: 1, requestSummarization: 1, inferredCost: 1, inferredBenefit: 1, priority: 1, explanation: 1, department: 1, status: 1, fieldWork: 1, location: 1, embedding: 1, createdAt: 1, updatedAt: 1, score: { $meta: 'vectorSearchScore' } } }",
